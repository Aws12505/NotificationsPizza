...
<body class="font-sans" style="background:#ffffff; color:#262626;">
    <div class="preheader">
        Your one-time code is {{ $data['otp'] }} — it expires in 10 minutes.
    </div>
                    ...
                    <tr>
                        <td style="padding-bottom:12px;" align="left">
                            <span class="badge font-sans">
                                {{ $data['type'] === 'verification' ? 'Email Verification' : 'Password Reset' }}
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="card" style="padding:32px;">
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                class="rounded-all" style="background:#fffbeb; border:1px solid #e5e7eb;">
                                <tr>
                                    <td style="padding:20px;">
                                        <div
                                            style="font-size:12px; letter-spacing:0.08em; text-transform:uppercase; color:#6b7280; padding-bottom:8px;">
                                            One-Time Code
                                        </div>
                                        <div class="font-mono"
                                            style="font-size:24px; font-weight:700; letter-spacing:0.12em; background:#ffffff; border:1px dashed #e5e7eb; border-radius:10px; padding:10px 14px; color:#262626; display:inline-block;">
                                            {{ $data['otp'] }}
                                        </div>
                                    </td>
                                </tr>
